...
class RemovePluginCommand extends PluginCommand
{
     ...
     * @var string
     */
    protected $name = 'Debixy:remove-plugin';
    ...
    public function handle(): void
    {
        ...
        if ($this->pluginIsStillActive()) {
            ...
            $message .= ' plugins inside the DebixyServiceProvider first.';
            $this->error($message);
    ...
    private function pluginIsStillActive(): bool
    {
        ...
        return isset(Debixy::availablePlugins()[$pluginClassName]);
    }
